...
ms.locfileid: "75191125"
---
# <a name="publish-a-spring-boot-app-as-a-docker-container-by-using-the-azure-toolkit-for-intellij-deprecated"></a>Публикация приложения Spring Boot в виде контейнера Docker с помощью Azure Toolkit for IntelliJ (ИНФОРМАЦИЯ УСТАРЕЛА)
...
Чтобы опубликовать приложение Spring Boot, необходимо создать готовый к развертыванию артефакт. Выполните указанные ниже действия.
