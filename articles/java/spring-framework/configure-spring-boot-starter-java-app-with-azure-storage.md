...
1. Задайте такие параметры:
   ...
   * Добавление зависимости **Spring Web**.
   ...
   > [!NOTE]
   > 1. Spring Initializr использует имена **Group** (Группы) и **Artifact** (Артефакта) для создания имени пакета, как например *com.wingtiptoys.storage*.
