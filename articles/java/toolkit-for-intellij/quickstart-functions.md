...
1. Щелкните правой кнопкой мыши функцию *HttpTrigger-Java* и выберите *Функция для триггеров*. Вы увидите, что браузер открыт с URL-адресом триггера.
    ...
    ![Адресная строка браузера с URL-адресом триггера](media/quickstart-functions/explorer-trigger-functions.png)
...
1. Удаление Функций Azure в Azure Explorer
      ...
      ![Удаление функции в обозревателе Azure](media/quickstart-functions/delete-function.png)
