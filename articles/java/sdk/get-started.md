...
Дополнительные способы аутентификации см. в описании [клиентской библиотеки Azure Identity для Java](https://github.com/Azure/azure-sdk-for-java/tree/master/sdk/identity/azure-identity#azure-identity-client-library-for-java).
...
На этом этапе создается базовый проект Maven в папке *testAzureApp*. Добавьте следующие записи в файл *pom.xml* проекта, чтобы импортировать библиотеки, используемые в примере кода в этом руководстве.
...
Перейти к файлу *helloazure.txt* в вашей учетной записи хранения можно с помощью портала Azure или [Обозревателя службы хранилища Azure](/azure/vs-azure-tools-storage-explorer-blobs).
...
Дополнительные сведения о том, как с применением библиотеки управления Azure для Java управлять ресурсами и автоматизировать задачи, см. в наших примерах кода для [виртуальных машин](virtual-machine-samples.md), [веб-приложений](web-apps-samples.md) и [Базы данных SQL](sql-database-samples.md).
...
Задавайте вопросы сообществу на сайте [Stack Overflow](https://stackoverflow.com/questions/tagged/azure+java). Сообщайте об ошибках и нерешенных проблемах с пакетами SDK Azure для Java в [репозитории GitHub](https://github.com/Azure/azure-sdk-for-java).
