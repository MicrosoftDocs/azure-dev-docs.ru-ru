...
|[![Логотип Java 15](media/supported-java-versions-java-15.png)](https://www.azul.com/downloads/azure-only/zulu/?version=java-15) |Март 2023 г. (MTS)|
...
- Поддерживаются корпорацией Майкрософт и Azul Systems.
   ...
   * Zulu поставляется с бесплатной долгосрочной поддержкой (LTS) для Java 7, 8 и 11 и среднесрочной поддержкой (MTS) для Java 13 и 15. (LTS будет также предоставляться для Java 17.) Вы можете обновлять версии Java, только если это необходимо.
   * Java 7 поддерживается до июля 2023 г. Java 8 поддерживается до декабря 2030 г. Java 11 поддерживается до сентября 2027 г. Java 13 и 15 поддерживаются до марта 2023 года.
...
- Готовы к производству.
   ...
   * Включают производственные обновления для Java SE, включая исправления ошибок, улучшения производительности и исправления системы безопасности для Java SE 7, 8, 11, 13 и 15.
