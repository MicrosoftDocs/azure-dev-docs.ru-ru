...
Библиотека удостоверений Azure — это самый новый пакет проверки подлинности для Azure. Проверьте файл сведений об используемой клиентской библиотеке, чтобы узнать, поддерживается ли эта новая библиотека.
...
* [Документация по пакетам npm Azure](/javascript/api/overview/azure/)
