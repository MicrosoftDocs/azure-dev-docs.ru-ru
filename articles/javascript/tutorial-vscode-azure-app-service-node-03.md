...
description: Руководство по Node.js, часть 3. Развертывание веб-сайта
ms.topic: tutorial
ms.date: 03/04/2020
...
1. В VS Code выберите значок системы управления версиями, чтобы открыть обозреватель **системы управления версиями**, а затем щелкните **Инициализировать репозиторий**, чтобы инициализировать локальный репозиторий Git.
