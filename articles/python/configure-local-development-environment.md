...
1. Создайте переменные среды, необходимые библиотекам Azure. (Объект `DefaultAzureCredential` библиотеки azure-identity ищет эти переменные.)
