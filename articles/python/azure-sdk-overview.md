...
- [Подготовка группы ресурсов к работе](azure-sdk-example-resource-group.md)
- [Перечисление групп ресурсов в подписке](azure-sdk-example-list-resource-groups.md)
- [Подготовка службы хранилища Azure к работе](azure-sdk-example-storage.md)
- [Подготовка веб-приложения и развертывание кода](azure-sdk-example-web-app.md)
- [Подготовка базы данных к работе и выполнение запросов к ней](azure-sdk-example-database.md)
...
- Если вы используете класс `ServicePrincipalCredentials`, см. раздел о [проверке подлинности с использованием учетных данных маркера](azure-sdk-authenticate.md#authenticate-with-token-credentials).
- Имена асинхронных API-интерфейсов изменились, как описано в разделе об Шаблоны использования библиотек [асинхронных операциях в статье, посвященной шаблонам использования библиотек](azure-sdk-library-usage-patterns.md#asynchronous-operations). Проще говоря, имена асинхронных API-интерфейсов в более новых библиотеках начинаются с `begin_`. В большинстве случаев сигнатура API остается той же.
...
В статье с [примером использования службы хранилища Azure](azure-sdk-example-storage-use.md) дается базовая иллюстрация использования клиентской библиотеки.
...
- [Размещение приложений](quickstarts-app-hosting.md)
- [Cognitive Services](quickstarts-cognitive-services.md)
- [Решения для работы с данными](quickstarts-data-solutions.md)
- [Идентификация и безопасность](quickstarts-identity-security.md)
- [Машинное обучение](quickstarts-machine-learning.md)
- [Обмен сообщениями и Интернет вещей](quickstarts-messaging-iot.md)
- [Другие службы](quickstarts-other-services.md)
