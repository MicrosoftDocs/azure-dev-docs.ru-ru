...
- **Наличие Terraform.** Следуйте указаниям в статье [Terraform и настройка доступа к Azure](get-started-cloud-shell.md).
...
1. Создайте план Terraform, чтобы визуализировать развертывание масштабируемого набора виртуальных машин. (Необходимо указать пароль и расположение ресурсов.)
