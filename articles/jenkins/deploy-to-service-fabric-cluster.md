...
- [Интерфейс командной строки Service Fabric (sfctl)](/azure/service-fabric/service-fabric-cli.md). Установите интерфейс командной строки на уровне системы, а не на уровне пользователя, чтобы среда Jenkins могла выполнять команды интерфейса командной строки. 
- Для развертывания приложений Java установите [Gradle и Open JDK 8.0](/azure/service-fabric/service-fabric-get-started-linux.md#set-up-java-development). 
- Для развертывания приложений .NET Core 2.0 установите [пакет SDK для .NET Core 2.0](/azure/service-fabric/service-fabric-get-started-linux.md#set-up-net-core-20-development). 
