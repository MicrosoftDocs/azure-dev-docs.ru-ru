...
description: Начните работу со Службой приложений Azure. Разверните первое приложение Python в контейнере Linux в Службе приложений.
ms.topic: quickstart
ms.date: 09/22/2020
...
## <a name="2-clone-the-sample"></a>2. Клонирования репозитория
...
## <a name="3-run-the-sample"></a>3. Запуск примера
...
## <a name="4-deploy-the-sample"></a>4. Развертывание примера
...
- Если команда `az` не распознана, проверьте, установили ли вы Azure CLI согласно сведениям, указанным в разделе [Настройка начальной среды](#setup).
...
## <a name="5-browse-to-the-app"></a>5. Переход в приложение
...
## <a name="6-redeploy-updates"></a>6. Повторное развертывание обновлений
...
## <a name="7-stream-logs"></a>7. Журналы потоковой передачи
...
## <a name="8-manage-the-azure-app"></a>8. Управление приложением Azure
